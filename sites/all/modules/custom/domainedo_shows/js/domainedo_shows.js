jQuery(function($) {
   ...
   */
  if (
    !$("#block-system-main .node-show").length &&
  ...
  if ($(".field-name-field-calendar-archive").length) {
    if ($(".field-name-field-calendar-archive a").attr("href") == "/calendrier")
      $(".field-name-field-calendar-archive a").hide();
  }
  ...
  if (isAndroid) {
    sms_link = $(
      '<a class="icon-chat chat-show" href="sms:?&body=' +
  ...
  if (
    ...
    sms_link = $(
      '<a class="icon-chat chat-show" href="sms:;body=https://www.domainedo.fr' +
        pathname +
        '"><span>Partager par SMS</span></a>'
    );
    sms_link.appendTo(social_wrapper);
  ...
  (function(d, s, id) {
    ...
    js.id = id;
    js.src =
      "https://connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v3.2&appId=1815308221819289&autoLogAppEvents=1";
    fjs.parentNode.insertBefore(js, fjs);
  })(document, "script", "facebook-jssdk");

  //Twitter
  const twitter_url =
    "https://twitter.com/intent/tweet?url=https%3A%2F%2Fdomainedo.fr" +
    pathname +
