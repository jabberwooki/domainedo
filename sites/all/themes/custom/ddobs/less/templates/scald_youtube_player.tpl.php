...
<?php else: ?>
  <iframe class="scald-youtube" title="<?php print $vars['title'] ?>" width="<?php print $vars['video_width'] ?>" src="<?php print $vars['video_url'] ?>" allow="autoplay; fullscreen" allowfullscreen></iframe>
<?php endif; ?>
