...
To use these stylesheets, rename the files and domainedo with the name of your theme.
...
domainedo-alpha-default-narrow.css
...
domainedo-alpha-default-normal.css
...
domainedo-alpha-default-wide.css
