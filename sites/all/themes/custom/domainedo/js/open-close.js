...
jQuery(function($) {
  ...
  $('.read-more').each(function(){
    ...
    array_read_more[cpt].link_close = $( '<a id="link-close-txt-' + cpt + '" href="#link-open-txt-' + cpt + '" class="link-close-txt">Cacher le texte</a>' );
    ...
    array_read_more[cpt].text_before_link = array_read_more[cpt].p_with_link_read_more.html().replace(/<a [^>]*class="read-more".*>(.*)<\/a>(.*)/gi, "");
